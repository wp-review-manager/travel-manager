...
?>
<li>
    <h3 class="TM_dynamic_post_title">
        <a href="<?php echo get_permalink($post->ID) ?>"><?php echo $post->post_title ?>
        </a>
    </h3>
    <div class="avatar_post">
        <div class="TM_trending_block_fav">
            <div class="TM_trending_block_fav_item TMTooltip">
                <span class="TMTooltipText">This post has been clapped <?php echo $star_count; ?> times<br/>view post to react</span>
                <span class="dashicons"><?php echo $iconSvg ?></span>
                <span class="star_count"><?php echo $star_count ?></span>
            </div>
            <div class="TM_trending_block_fav_item">
